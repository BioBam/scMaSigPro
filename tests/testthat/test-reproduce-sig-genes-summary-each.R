...
test_that("Check-'tstep$SOL' Reproducibility: Match, Dimension, Name and Value", {
    ...
    # Extract sigs
    test.scmp.2 <- sc.get.siggenes(test.scmp.2, rsq = 0.6, vars = "each")
    test.scmp.3 <- sc.get.siggenes(test.scmp.3, rsq = 0.6, vars = "each")
    test.scmp.4 <- sc.get.siggenes(test.scmp.4, rsq = 0.6, vars = "each")
