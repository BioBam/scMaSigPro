...
test_that("Check-'design$dis' Reproducibility: Match, Dimension, Name and Value", {
    ...
    # Check
    # Poly-order-2
    expect_equal(expected = design_2$dis,
                           object = test.scmp.2@edesign@dis)
    
    # Poly-order-3
    expect_equal(expected = design_3$dis,
                 object = test.scmp.3@edesign@dis)
    
    # Poly-order-4
    expect_equal(expected = design_4$dis,
                 object = test.scmp.4@edesign@dis)
})