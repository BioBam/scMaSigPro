...
### Cluster Trends
<!-- To discern general trends among the genes, we can cluster and visualize them together using the `plotTrendCluster()`. By default, this function employs hierarchical clustering (hclust) and we will divide the genes into 4 clusters. -->
<!-- ```{r, "Cluster Trends"} -->
<!-- plotTrendCluster( -->
<!--   scmp.ob, -->
<!--   geneSet = "intersect", -->
