...
expect_identical(scmp.ob@significant@genes$ColdvsControl,
  expected = sigs$summary$ColdvsControl
)

# Compare Heat vs Control
expect_identical(scmp.ob@significant@genes$HeatvsControl,
  expected = sigs$summary$HeatvsControl[sigs$summary$HeatvsControl != " "]
)

# Compare Salt vs Control
expect_identical(scmp.ob@significant@genes$SaltvsControl,
  expected = sigs$summary$SaltvsControl[sigs$summary$SaltvsControl != " "]
)

# Compare Control
expect_identical(scmp.ob@significant@genes$Control,
