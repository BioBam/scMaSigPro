...
#'
#' @description This function annoated the Monocle3's CellDataSet (CDS). It uses
...
#' @param verbose Logical. If TRUE, print the identified root points and
#' information about the longest and shortest paths. Default is TRUE.
#'
#' @details The function first extracts the principal points and root cells from 
...
#' \code{\link[igraph]{shortest_paths}}, \code{\link[monocle3]{pseudotime}}
#'
#' @examples
#' \dontrun{
#' # Assuming 'cds' is a Monocle3 CellDataSet (CDS)
#' result <- annotate_monocle3_cds(cds, reduction_method = "umap",
#'                                     path_prefix = "Path", 
#'                                     root_label = "root",
