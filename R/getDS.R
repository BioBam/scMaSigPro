...
#' \code{getDS} creates lists of significant isoforms from Differentially Spliced Genes (DSG).
#'
#' @param Model A \code{IsoModel} object
#' @param vars Argument of the \code{\link{get.siggenes}} function applied to isoforms
#' @param rsq Cut-off level at the R-squared value for the stepwise regression fit. Only isoforms with R-squared more than rsq are selected
#'
#' @details
#' There are 3 possible values for the vars argument: "all", "each", and "groups". See \code{\link{get.siggenes}}.
#'
#' @return A list with:
#' * Model: a \code{IsoModel} object to be used in the following steps
#' * get2: a \code{get.siggenes} object to be used in the following steps
#' * DSG: Names of the selected genes: Differentially Spliced Genes
#' * DET: Names of the selected Isoforms: Differentially Expressed Transcripts
